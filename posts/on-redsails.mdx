---
title: On Red Sails
description: "and Roderic Day, and Nia Frome"
date: Dec 19 2022
---
...
Roderic and Nia both do a great job writing (and curating!) articles for RedSails. The works done by the team can be found using the [@crew subdirectory](https://redsails.org/@crew/), or individually under [@roderic](https://redsails.org/@roderic/) and [@nia](https://redsails.org/@nia/).
...
As I address in my posts [On Feminism](/posts/on-feminism) and [On Trans Rights](/posts/on-trans-rights), the authors present on RedSails have heavily influenced my views on these topics.

[The Woman Question](https://redsails.org/the-woman-question/) (2016) by [Lori Watson](https://read.dukeupress.edu/tsq/article-standard/3/1-2/246/91778/The-Woman-Question) is one of my favorite pieces dealing with questions pertinent to the lives of trans women. [Sobrina de Alguien](https://redsails.org/@sobri/)'s [Men value my opinion](https://redsails.org/los-hombres-valoran-mi-opinion/) (2020) was also a thought provoking piece that helped shape my thoughts and actions moving forward.

RedSails also provides good introductions to [Alexandra Kollontai](https://redsails.org/the-social-basis-of-the-woman-question/), [Catharine A. MacKinnon](https://redsails.org/what-is-a-white-woman-anyway/), [Jo Freeman](https://redsails.org/the-tyranny-of-structurelessness/), and some other lesser-known but very compelling [feminists](https://redsails.org/@feminism/)
...
And recently, I found John Kessel's [Creating the Innocent Killer: Ender’s Game, Intention, and Morality](https://redsails.org/creating-the-innocent-killer/) (2004) very compelling in the [Art and Propaganda](https://redsails.org/@art&propaganda/) section.

---

## Marxism-Leninism

I suppose back when I came upon RedSails, I'm not sure I yet self-identified as a Marxist-Leninist. I document some of my journey in the philosophy section of the site, especially in [Part III](/posts/on-communists). I was still rapidly getting caught up on history, philosophy, nature, change, what all the new ideological labels meant (especially re: how they varied in practice).
...
The RedSails sections on [Latin America](https://redsails.org/@latin-america/) has some great material here

---

## Fascism and Colonialism

These are terms that are a bit difficult to tackle, especially because they're hard to define concepts that shape with time (I'll admit, I too am the type of guy who would prefer a simple checklist test to determine everything. But there's great nuance when dealing with topics as serious as these). The [Fascism and Colonialism](https://redsails.org/@fascism/) is dedicated to looking at how these ideologies and movements crystallize in our material world.

Check out Roderic's [Really Existing Fascism](https://redsails.org/really-existing-fascism/) (2021) to see him draw some great parallels between the various societal projects pursuing socialism and those pursuing fascism.

---

## Black Liberation

RedSails has linked to some great authors on the topic of [Black Liberation](https://redsails.org/@black-liberation/). Huey Newton's [In Defense of Self-Defense](https://redsails.org/in-defense-of-self-defense/) (1968) is a great modern take on the question ["Anarchism or Socialism?"](https://www.marxists.org/reference/archive/stalin/works/1906/12/x01.htm) (that link is to Stalin's 1907 piece). Huey's take (in brief, though I recommend reading the full piece):
...
RedSails also provides short pieces that can help you get introduced to the works of other great writers like [Walter Rodney](https://redsails.org/marxism-in-africa/), [Assata Shakur](https://redsails.org/assata-and-pastors/), [W.E.B. Du Bois](https://redsails.org/on-stalin/), [Aimé Césaire](https://redsails.org/discours-sur-le-colonialisme/), and [Kwame Nkrumah](https://redsails.org/nkrumah-on-welfare-and-imperialism/).

Sundiata Acoli's [A Brief History of the Black Panther Party and Its Place In the Black Liberation Movement](https://redsails.org/a-brief-history-of-the-black-panther-party/) (2008) also provides a great look at the Black Panther Party.

[The Logic of Stupid Poor People](https://redsails.org/the-logic-of-stupid-poor-people/) (2013) by Tressie McMillan Cottom is a great modern piece that may provide perspective you haven't encountered before.

For more on this topic, you can check out my article [On Black Liberation](/posts/on-black-liberation).

---

## Losurdo

The RedSails folks were my introduction to Domenico Losurdo. Their [Losurdo section](https://redsails.org/@losurdo/) has a few good introductions to his work.
...
### RedSails General Orientation - Jan 16, 2022 ([src](https://twitter.com/RodericDay/status/1482724733540253707))
...
I've separated those into [On Nia Frome](/posts/on-nia-frome) and [On Roderic Day](/posts/on-roderic-day) because this got large.
